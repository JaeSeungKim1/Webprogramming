...
conn = pymysql.connect(host='localhost', user='root', password='horang2!#%&(', db='shop')
curs = conn.cursor(pymysql.cursors.DictCursor)

# excel file load
excel_sheet_1 = pd.read_excel('D:\pythonwork\input\\nation.xlsx', sheet_name = 'nation')
excel_sheet_2 = pd.read_excel('D:\pythonwork\input\\nation.xlsx', sheet_name = 'city')
